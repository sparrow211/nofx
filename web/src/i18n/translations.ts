...
export const translations = {
  en: {
    ...
    // ===== INSTALLATION =====
    faqHowToInstall: 'How do I install AIBTC?',
  ...
  zh: {
    ...
    nofxDescription1: "一个透明、高可用的，提供统一的 '决策-风险-执行'",
